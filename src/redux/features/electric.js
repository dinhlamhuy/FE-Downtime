...
export const get_top_longest_repair_time = createAsyncThunk("/task/getTop5LongestRepairTime", async ({  factory, floor, lean, time }) => {
    try {
        const data = await ElectricServices.get_top_longest_repair_time(factory, floor, lean, time);
        return data;
    } catch (error) {
        return error.message;
    }
...
export const get_top3_broken_machines = createAsyncThunk("/task/getTop3BrokenMachines", async ({  factory, floor, lean, time }) => {
    try {
        const data = await ElectricServices.get_top3_broken_machines(factory, floor, lean, time);
        return data;
    } catch (error) {
        return error.message;
    }
...
export const get_work_list_report_employee = createAsyncThunk("/task/getTaskmechaInfo", async ({ id_user_mechanic, factory, lean }) => {
    try {
        const data = await ElectricServices.get_work_list_report_employee(id_user_mechanic, factory, lean);
        return data;
    } catch (error) {
        return error.message;
    }
